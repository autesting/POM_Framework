...

{
	...
	public static void main (String args[]) throws InterruptedException {
		...
		driver.get("https://accounts.google.com/o/oauth2/v2/auth/oauthchooseaccount?redirect_uri=https%3A%2F%2Fdevelopers.google.com%2Foauthplayground&prompt=consent&response_type=code&client_id=407408718192.apps.googleusercontent.com&scope=email&access_type=offline&flowName=GeneralOAuthFlow");System.out.println("READhtmlUtilityMethodsStringREADhtmlUtilityMethodsStringREADhtmlUtilityMethodsStr");
		Thread.sleep(3000);
